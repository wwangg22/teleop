...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "TemperatureDisplay = rebotarmcontroller.temperature_display:main",
            "HomeButton = rebotarmcontroller.home_button:main",
            "MockPolicy = rebotarmcontroller.mock_policy:main",
        ],
    },
)
